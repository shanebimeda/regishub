...
The following interactive plot shows the **Covid19-positive individuals and their contacts** in  **Bicol Region** as of **September 01, 2020**.  
...
## Time Varying R in Bicol Region as of **September 01, 2020**
...
##Computed R  (Mean R) Value for the Province of Bicol for **September 01 or Day `r r[nrow(r), 2]`** 
