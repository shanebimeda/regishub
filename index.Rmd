...
The following interactive plot shows the **Covid19-positive individuals and their contacts** in  **Bicol Region** as of **July 9, 2020**.  
...
## Time Varying R in Bicol Region as of **July 9, 2020**
...
**packages used: dplyr, data.table, lubridate, reshape2, ggplot2, EpiEstim, epicontacts, googlesheet4, readxl**
