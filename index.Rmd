...
The following interactive plot shows the **Covid19-positive individuals and their contacts** in  **Bicol Region** as of **September 15, 2020**.  
...
## Time Varying R in Bicol Region as of **September 15, 2020**
...
##Computed R  (Mean R) Value for Bicol Region on **September 15 or Day `r r[nrow(r), 2]`** 
