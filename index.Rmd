...
The following interactive plot shows the **Covid19-positive individuals and their contacts** in  **Bicol Region** as of **September 14, 2020**.  
...
## Time Varying R in Bicol Region as of **September 14, 2020**
...
##Computed R  (Mean R) Value for Bicol Region on **September 14 or Day `r r[nrow(r), 2]`** 
